...
| `scin_exit_x` | float | mm | Photon x where it exits the scintillator volume |
| `scin_exit_y` | float | mm | Photon y where it exits the scintillator volume |
| `scin_exit_z` | float | mm | Photon z where it exits the scintillator volume |
